...
function App() {
  return (
    <div className="relative w-screen sm:min-h-screen lg:h-screen bg-[#242424] flex justify-center items-center lg:overflow-hidden font-poppins">
      <div
        className={`flex lg:h-3/4 md:h-screen md:w-screen  lg:w-3/4 bg-cover bg-center bg-no-repeat bg-[url(./assets/rainy.webp)] flex-col w-full h-full lg:flex-row lg:drop-shadow-2xl/70`}
      >
